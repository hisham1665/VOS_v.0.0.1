...
from aos_v0.core.graph_utils import (
    validate_graph,
    build_waves,
    get_sink_nodes,
    GraphValidationError,
)
from aos_v0.core.diagram_utils import build_mermaid
...
class ManagerAgent:
    ...
    def __init__(self):
        self._client = make_groq(GROQ_API_KEY)
    ...
    def create_plan(self, user_prompt: str, inputs: Optional[dict[str, str]] = None) -> Graph:
        ...
        print(
            "[manager-agent] graph written to data/outputs/plan.md "
    ...
    def _write_plan_md(graph: Graph) -> None:
        ...
        path = project_root / "data" / "outputs" / "plan.md"
