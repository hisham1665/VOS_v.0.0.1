...
Produces ``data/outputs/registry_data.json`` containing every registered resource
...
Run with ``python -m aos_v0.services.registry_export``.
"""
...
from aos_v0.providers import hf as hf_mod

OUT = Path(__file__).resolve().parents[3] / "data" / "outputs" / "registry_data.json"
